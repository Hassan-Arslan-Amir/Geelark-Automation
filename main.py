...
if __name__ == "__main__":
    ...
    # Log Step 1 → create content record with local path
    content_id = create_content_record(local_path=local_file)
    ...
    # Step 6: Increment post count for each successfully tasked device
    successful_ids = [
        r["profileId"] for r in results if r["status"] == "created"
    ]
